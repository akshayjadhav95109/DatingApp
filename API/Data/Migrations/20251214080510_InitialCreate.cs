    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SourceMemeberId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TargetMemberId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Likes", x => new { x.SourceMemeberId, x.TargetMemberId });
                    table.ForeignKey(
                        name: "FK_Likes_Members_SourceMemeberId",
                        column: x => x.SourceMemeberId,
