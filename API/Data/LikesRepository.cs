...
public class LikesRepository(AppDbContext context) : ILikesRepository
{
    ...
    public async Task<IReadOnlyList<string>> GetCurrentMemberLikeIds(string memberId)
    {
        ...
        .Where(x=> x.SourceMemeberId == memberId)
    ...
    public async Task<PaginatedResults<Member>> GetMemberLikes(LikesParams likesParams)
    {
        ...
        switch(likesParams.Predicate)
        {
            case "liked":
                result = query
                .Where(like=> like.SourceMemeberId==likesParams.MemberId)
            ...
            default: //mutual
                ...
                result = query
                .Where(like=> like.TargetMemberId==likesParams.MemberId && likeIds.Contains(like.SourceMemeberId))
                .Select(like=>like.SourceMember);
                break;
        }
