...
public class MessageRepository(AppDbContext context) : IMessageRepository
{
    ...
    public async Task<PaginatedResults<MessageDto>> GetMessagesForMemeber(MessageParams messageParams)
    {
    ...
    {
        //recipientId meaning another user who is involved in conversation

        //mark dateread for incoming messages from recipientId
