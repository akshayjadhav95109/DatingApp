...
export class MemberList implements OnInit {
  ...
  get displayMessage(): string {
    ...
    if(this.updatedParams.minAge !== defalutParams.minAge || this.updatedParams.maxAge !== defalutParams.maxAge) {
    ...
    return filters.length > 0 ? `Seleced: ${filters.join(' | ')}` : 'All memebers';
  }
}
